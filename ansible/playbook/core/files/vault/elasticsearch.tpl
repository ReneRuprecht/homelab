{{ with pkiCert "pki-int-core/issue/core-services" "common_name=elastic.core.internal" "alt_names=elastic-01.core.internal,fleet.core.internal,kibana.core.internal,elasticsearch.core.internal" }}
